...
INSERT INTO [dbo].[Beneficiary] (beneficiary_name,beneficiary_address,project_location_id,contact_id,is_active) values ('BF1','ADDR LINE1',1,1,1),('BF2','ADDR LINE2',2,2,1),('BF3','ADDR LINE3',3,2,1),('BF4','ADDR LINE4',4,3,1),('BF5','ADDR LINE5',5,3,1),('BF6','ADDR LINE6',6,4,1),('BF7','ADDR LINE1',1,4,1),('BF8','ADDR LINE1',1,4,1);
GO

INSERT INTO [dbo].[Funds] (fund_desc,fund_amount) values ("F1",50000),("F2",5000),("F3",10000),("F4",15000),("F5",10000),("F6",12000),("F7",1400),("F8",50000);RT INTO [dbo].[Funds] (fund_desc,fund_amount) values('Funds1',50000),('Funds2',5000),('Funds3',10000),('Funds4',15000),('Funds5',10000),('Funds6',12000),('Funds7',1400),('Funds8',50000);
GO
